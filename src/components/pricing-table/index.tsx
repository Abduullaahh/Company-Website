    ...
    <div className={tw(`relative max-w-7xl mx-auto mb-24`)}>
      <header className={tw(`py-8 px-6 md:px-0 lg:flex-shrink-1`)}>
        ...
        <p className={tw(`mt-6 text-base leading-6 text-gray-500`)}>
          Discover how DevSol can transform your business with our comprehensive solutions. Join us in taking your
            ...
            {features.map((feature) => {
              ...
              return (
                <li className={tw(`flex items-center lg:col-span-1`)} key={feature}>
                  ...
                  <p className={tw(`text-gray-600 mr-10`)}>
                    <strong className={tw(`font-bold`)}>{title}:</strong> {description}
                  </p>
                </li>
              );
            })}
